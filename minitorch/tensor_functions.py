...
class Neg(Function):
    @staticmethod
    def forward(_: Context, t1: Tensor) -> Tensor:
        return t1.f.neg_map(t1)

    @staticmethod
    def backward(_: Context, grad_output: Tensor) -> Tensor:
...
class Exp(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        (t1,) = ctx.saved_values
        return grad_output.f.mul_zip(grad_output, grad_output.f.exp_map(t1))
